...
const UploadArtwork = () => {
  ...
  return (
    <>
      <button
        className="text-teal-400 hover:text-gray-500 text-lg"
        type="button"
      ...
      {showModal ? (
            ...
            <div className="relative w-auto my-6 mx-auto max-w-md">
              <div className="border-2 border-black rounded-lg shadow-lg relative flex flex-col w-full bg-teal-400 outline-none focus:outline-none">
                <div className="flex flex-col items-start justify-between p-5 border-b border-solid border-black rounded-t ">
                  <h3 className="text-3xl text-black text-center font=semibold">UPLOAD ARTWORK</h3>
                </div>
        ...
        <>
            ...
            <div className="mb-4">
                  ...
                  <button
                    className="text-white hover:text-gray-400 bg-black font-bold uppercase px-6 py-2 rounded text-sm outline-none focus:outline-none mr-1 mb-1"
                    type="button"
